...
router.post("/", async (req, res) => {
  try {
    ...
    const mailOptions = {
      to: user.email,
      from: "funkybuddha747@gmail.com",
      subject: "Hi there! Password reset request",
      html: `<p>Hey ${
        user.name.split(" ")[0]
      },There was request for password request. <a href=${href}>Click this link to reset the password </a></p>
...
//VERIFY THE TOKEN AND RESET THE PASSWORD IN THE DB
